<?php
if (isset($don_hang_huy)) {
    if (is_array($don_hang_huy)) {
        if (count($don_hang_huy) > 0) {
            foreach ($don_hang_huy as $dh) {
                extract($dh);
...
?>
<h5 class="alert alert-primary">Đơn hàng đã huỷ</h5>
<table class="table">
    <thead>
        <tr>
            <th scope="col">#</th>
            ...
            if (count($don_hang_huy) > 0) {
                foreach ($don_hang_huy as $dh) {
                    ...
                    <tr>
                        ...
                        <td>
                            <p class="text-danger"><?php echo $tinh_trang; ?></p> <a href="index.php?xoa_don_hang&id_hoa_don=<?php echo $id_hoa_don; ?>" class="btn btn-danger">Xoá</a>
                        </td>
                    </tr>
                <?php
                }
