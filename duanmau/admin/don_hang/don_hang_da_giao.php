<?php
if (is_array($don_hang_da_giao)) {
    if (count($don_hang_da_giao) > 0) {
        foreach ($don_hang_da_giao as $dh) {
            extract($dh);
...
?>
<h5 class="alert alert-primary">Đơn hàng đã giao</h5>
<table class="table">
    <thead>
        <tr>
            <th scope="col">#</th>
